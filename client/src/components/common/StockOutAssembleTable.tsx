...
import { getStockOutPerItem, updateStockOut } from "../../api/services/stock"
...
const StockOutAssembleTable = ({ productId, close }: StockOutTableProps) => {
  ...
  const {
    ...
    isLoading,
    isError,
  } = useQuery<AssembleTransaction[]>({
    queryKey: ["StockOut", "Raw Mats"],
    queryFn: () => getStockOutPerItem(productId),
    enabled: !!productId,
  })
...
export default StockOutAssembleTable
